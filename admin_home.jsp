                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           ...
                           <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                <button class="dropdown-item" type="button"><a href="veiw_order.jsp"> View_Order</a></button>
                                <button class="dropdown-item" type="button"><a href="view_buyer.jsp"> View_Buyer</a></button>
                                <button class="dropdown-item" type="button"><a href="view_customer.jsp"> View_Customer</a></button>
                                <button class="dropdown-item" type="button"><a href="view_doctor.jsp"> View_Doctor</a></button>
                                <button class="dropdown-item" type="button"><a href="view_product.jsp"> View_Product</a></button>
                                <button class="dropdown-item" type="button"><a href="view_shopkeeper.jsp"> View_Shop_keper</a></button>
                                <button class="dropdown-item" type="button"><a href="farmer_view.jsp"> View_farmer</a></button>
                                <button class="dropdown-item" type="button"><a href="chart_view.jsp"> View_chart</a></button>
                              </div>
                            </div>
                        </div>
                     </nav>
