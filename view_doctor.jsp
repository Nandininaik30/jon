...
<br><br><br><br><br><br><center><%@page import="java.sql.*"%>
    ...
    <tr>
      ...
      <th>DOCTOR_NAME</th>
      <th>DOCTOR_EMAIL</th>
      <th>DOCTOR_PINCODE</th>
      <th>DOCTOR_CLINIC_NAME</th>
      <th>DOCTOR_CLINIC_ADDRESS</th>
      <th> delete</th>
    ...
    ResultSet rs=stmt.executeQuery("select  * from docter_tables ");
    while(rs.next())
    {
      out.println("<tr> <td>");
      ...
      %>
    <a href="delete_doctor_details.jsp?ro=<%=rs.getString(1) %>"> Delete </a>
