                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           ...
                           <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                <button class="dropdown-item" type="button"><a href="order_insert.html"> Order</a></button>
                                <button class="dropdown-item" type="button"><a href="Buyer_Registration.html"> Buyer</a></button>
                                <button class="dropdown-item" type="button"><a href="customer_insert.html"> Customer</a></button>
                                <button class="dropdown-item" type="button"><a href="doctorinfo.html"> Doctor</a></button>
                                <button class="dropdown-item" type="button"><a href="product_insert.html"> Product</a></button>
                                <button class="dropdown-item" type="button"><a href="shopkeeper_insert.html"> Shop_keper</a></button>
                                <button class="dropdown-item" type="button"><a href="Farmer_registration.html">farmer</a></button>
                                <button class="dropdown-item" type="button"><a href="chart.html"> chart</a></button>
                              </div>
                            </div>
                        </div>
                     </nav>
